                                ...
                                <td colSpan={6} className="py-3 text-sm text-gray-600">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <button
                                                className="inline-flex items-center p-4 text-sm text-zinc-500 hover:text-zinc-900 font-medium">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    fill="none"
                                                    viewBox="0 0 24 24"
                                            ...
                                            <div className="flex items-center gap-1">
                                                {[1, 2, 3, "...", 5].map((page, index) => (
                                                    <button
                                                        key={index}
                                                        className={`px-3 py-1.5 text-sm font-medium text-zinc-500 hover:text-white hover:bg-blue-600 rounded-md ${
                                            ...
                                            <button
                                                className="inline-flex items-center p-4 text-sm text-zinc-500 hover:text-zinc-900 font-lg">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    fill="none"
                                                    viewBox="0 0 24 24"
